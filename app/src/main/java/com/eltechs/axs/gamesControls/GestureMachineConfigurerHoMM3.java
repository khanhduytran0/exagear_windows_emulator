...
public class GestureMachineConfigurerHoMM3 {
    ...
    public static GestureContext createGestureContext(ViewOfXServer viewOfXServer, TouchArea touchArea, TouchEventMultiplexor touchEventMultiplexor, int i, Runnable runnable) {
        ...
        SimpleMousePointAndClickAdapter simpleMousePointAndClickAdapter4 = simpleMousePointAndClickAdapter3;
        ...
        AlignedMouseClickAdapter alignedMouseClickAdapter3 = new AlignedMouseClickAdapter(new SimpleMouseMoveAdapter(gestureContext.getPointerReporter()), new PressAndHoldMouseClickAdapter(gestureContext.getPointerReporter(), 3), new PressAndReleaseMouseClickAdapter(gestureContext.getPointerReporter(), 1, 50), viewOfXServer2, pointerContext, f2);
        MouseClickAdapterWithCheckPlacementContext mouseClickAdapterWithCheckPlacementContext2 = new MouseClickAdapterWithCheckPlacementContext(simpleMousePointAndClickAdapter4, alignedMouseClickAdapter3, new SimpleMousePointAndClickAdapter(new SimpleMouseMoveAdapter(gestureContext.getPointerReporter()), new PressAndHoldMouseClickAdapter(gestureContext.getPointerReporter(), 3), pointerContext), pointerContext, 200);
        ...
        // GestureState1FingerMoveToScrollSync gestureState1FingerMoveToScrollSync = r0;
        ...
        finiteStateMachine.setStatesList(gestureStateNeutral, gestureState1FingerMeasureSpeed, gestureStateMouseWarpToFingerLastCoords2, gestureStateClickToFingerFirstCoords2, gestureStateCheckIfZoomed2, gestureStateWaitFingersNumberChangeWithTimeout4, gestureStateWaitFingersNumberChangeWithTimeout3, fSMStateRunRunnable3, gestureStatePressKey5, gestureStatePressKey4, gestureState1FingerMoveToMouseMove3, gestureState1FingerToLongClick2, gestureState1FingerMoveToScrollSync3, gestureState1FingerToZoomMove, gestureState2FingersToZoom, gestureStateWaitForNeutral2);
        ...
        finiteStateMachine.addTransition(gestureState1FingerMeasureSpeed, GestureState1FingerMeasureSpeed.FINGER_WALKED, gestureState1FingerMoveToMouseMove3);
        ...
        finiteStateMachine.addTransition(gestureStateWaitFingersNumberChangeWithTimeout5, GestureStateWaitFingersNumberChangeWithTimeout.FINGER_RELEASED, gestureStatePressKey4);
        ...
        finiteStateMachine.addTransition(gestureStateWaitFingersNumberChangeWithTimeout6, GestureStateWaitFingersNumberChangeWithTimeout.FINGER_TOUCHED, fSMStateRunRunnable3);
