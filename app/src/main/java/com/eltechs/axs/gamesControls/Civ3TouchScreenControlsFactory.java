...
public class Civ3TouchScreenControlsFactory implements TouchScreenControlsFactory {
    ...
    private void fillTouchScreenControls(TouchScreenControls touchScreenControls, View view, ViewOfXServer viewOfXServer) {
        ...
        if (view.getWidth() > displayMetrics.widthPixels / 2) {
            ...
            this.gestureContext = GestureMachineConfigurerCiv3.createGestureContext(viewOfXServer2, touchArea2, touchEventMultiplexor2, displayMetrics.densityDpi, this.mouseMode, new Runnable() {
                public void run() {
